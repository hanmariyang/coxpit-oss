...
| [v5.0-console-redesign.md](v5.0-console-redesign.md) | v5.0 | navigator rail (repo list + scoping + view nav) · launch as a New sheet (Task/Goal/Workbench) · pocket board · ⌘K · compare-review fix · English sweep | spec ready |
